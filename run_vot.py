...
def run_vot2020(tracker_name, tracker_param, Ngpu=0, run_id=None, debug=0, visdom_info=None):
    os.environ["CUDA_VISIBLE_DEVICES"]= str(Ngpu)  # specify which GPU(s) to be used
